...
public class NormalOrderPresenter extends NormalOrderContract.Presenter {
    ...
    public void cancelOrder(String orderId) {
        mRxManage.add(mModel.cancelOrder(orderId).subscribe(new RxSubscriber<BaseBeanResult>(mContext, true) {
            @Override
            protected void _onNext(BaseBeanResult baseBeanResult) {
    ...
    public void getOrder(String orderId) {
        mRxManage.add(mModel.getOrder(orderId).subscribe(new RxSubscriber<BaseBeanResult>(mContext, true) {
            @Override
            protected void _onNext(BaseBeanResult baseBeanResult) {
    ...
    public void delOrder(String orderId) {
        mRxManage.add(mModel.delOrder(orderId).subscribe(new RxSubscriber<BaseBeanResult>(mContext, true) {
            @Override
            protected void _onNext(BaseBeanResult baseBeanResult) {
