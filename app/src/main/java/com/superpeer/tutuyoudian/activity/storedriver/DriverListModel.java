...
public class DriverListModel implements DriverListContract.Model {
    @Override
    public Observable<BaseBeanResult> queryRunners(String shopId) {
        return Api.getInstance().service.queryRunners(shopId).map(new Func1<BaseBeanResult, BaseBeanResult>() {
            @Override
