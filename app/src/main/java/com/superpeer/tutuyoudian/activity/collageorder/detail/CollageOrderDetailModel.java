...
public class CollageOrderDetailModel implements CollageOrderDetailContract.Model {
    @Override
    public Observable<BaseBeanResult> getOrderInfo(String orderId) {
        return Api.getInstance().service.groupOrderInfo(orderId).map(new Func1<BaseBeanResult, BaseBeanResult>() {
            @Override
