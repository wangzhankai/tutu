...
import com.superpeer.tutuyoudian.adapter.IncomeAdapter;
import com.superpeer.tutuyoudian.base.BaseActivity;
import com.superpeer.tutuyoudian.bean.BaseBeanResult;
import com.superpeer.tutuyoudian.constant.Constants;

public class IncomeDetailActivity extends BaseActivity<IncomeDetailPresenter, IncomeDetailModel> implements IncomeDetailContract.View, BaseQuickAdapter.RequestLoadMoreListener, RefreshLayout.RefreshLayoutDelegate {
    ...
    public void initView() {
        ...
        mPresenter.getDetail(PreferencesUtils.getString(mContext, Constants.SHOP_ID), PAGE+"", "10");
    }
    ...
    private void initRecyclerView() {
        ...
        adapter = new IncomeAdapter(R.layout.item_income, null);
