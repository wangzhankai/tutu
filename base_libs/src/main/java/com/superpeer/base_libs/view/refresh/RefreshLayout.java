package com.superpeer.base_libs.view.refresh;
...
public class RefreshLayout extends LinearLayout {
    ...
    /**
     * 整个头部控件，下拉刷新控件mRefreshHeaderView和下拉刷新控件下方的自定义组件mCustomHeaderView的父控件
     */
     ...
     * @return
     */
    public boolean isLoadingMore(boolean b) {
        return mIsLoadingMore=b;
    }
