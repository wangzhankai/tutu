...
public class DialogUtil {
    ...
    public static AlertDialog.Builder dialogBuilder(Context context, String title, String msg, View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        if (msg != null) {
            builder.setMessage(Html.fromHtml(msg));
        }
    ...
    public static Dialog showTips(Context context, String title, String message, View view) {
        return showTips(context, title, message,  view, null, null);
    }
    ...
    public static Dialog showTips(Context context, String title, String message, View view, String btn, DialogInterface
            .OnDismissListener dismissListener) {
        AlertDialog.Builder builder = dialogBuilder(context, title, message, view);
        builder.setCancelable(true);
        builder.setPositiveButton(btn, null);
        Dialog dialog = builder.show();
        dialog.setCanceledOnTouchOutside(true);
